...
@section('content')
    <div class="w-full px-6 sm:px-10 flex justify-center items-center h-screen">
        <div class="">
            ...
            <div class="w-[540px] p-4 bg-white border border-gray-200 rounded-lg shadow-xl sm:p-6 md:p-8">
                <div class="space-y-6">
