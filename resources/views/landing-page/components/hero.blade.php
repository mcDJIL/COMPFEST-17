    ...
    <div class="max-w-screen-xl w-full flex justify-center mx-auto px-6 sm:px-10 pb-20">
        <div class="flex w-full flex-wrap flex-col-reverse md:flex-row md:justify-between">
            <div class="mt-10 md:mt-7 lg:mt-10 xl:mt-16">
                ...
                <p class="text-gray-500 sm:w-96 md:w-64 lg:w-80 xl:w-96 mt-10 md:mt-6 lg:mt-8 xl:mt-10 text base md:text-xs lg:text-sm xl:text-base" data-aos="fade-up" data-aos-delay="200">SEA Catering as a customizable healthy meal service with delivery all across Indonesia.</p>

                <div class="mt-10 md:mt-6 lg:mt-8 xl:mt-10 flex flex-wrap gap-5" data-aos="zoom-in" data-aos-delay="400">
                ...
                <div class="mt-10 md:mt-6 lg:mt-8 xl:mt-10 flex flex-wrap gap-10 sm:gap-16" data-aos="fade-up" data-aos-delay="600">
                    <div class="">
