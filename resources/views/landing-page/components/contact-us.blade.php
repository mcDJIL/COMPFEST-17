        ...
        <div class="flex flex-wrap justify-between gap-10 xl:gap-30 w-full">
            ...
            <div class="flex flex-wrap justify-between gap-5 sm:gap-36 w-full sm:w-auto flex-1 xl:flex-auto aos-init aos-animate" data-aos="fade-left">
                <div class="">
                    ...
                    <p class="font-semibold text-[#333333] mb-1.5">Our Contact Info</p>
                    <p class="text-[#333333] mb-1">Manager : Brian</p>
                    <p class="text-[#333333]">08123456789</p>
                </div>

                <div class="">
                    <div class="mb-2 w-10 h-10 rounded-[10px] bg-green-800 text-white flex justify-center items-center">
                        <i class="fa-solid fa-location text-xl"></i>
                    </div>

                    <p class="font-semibold text-[#333333] mb-1.5">Our Address</p>
                    <p class="text-[#333333] w-64">Jl. Raya ITS, Keputih, Kec. Sukolilo, Surabaya, Jawa Timur 60111</p>
                </div>
            </div>
        </div>
    </div>
