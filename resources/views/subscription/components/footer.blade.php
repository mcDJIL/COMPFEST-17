...
<footer class="w-full pb-8 pt-14 bg-[#FAFAF5]">
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-10">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="/" class="flex items-center">
                  <img src="{{ url('assets/images/logo.png') }}" class="h-20 me-3" alt="Sea Catering Logo" />
              </a>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  <h2 class="mb-6 font-semibold text-[#333333] uppercase dark:text-white">Legal</h2>
                  <ul class="text-[#333333] dark:text-gray-400 font-medium">
                      <li class="mb-4">
      ...
      <hr class="my-6 border-[#333333] sm:mx-auto lg:my-8" />
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-[#333333] sm:text-center">© 2025 <a href="/" class="hover:underline">SeaCatering</a>. All Rights Reserved.
          </span>
          <div class="flex mt-4 sm:justify-center sm:mt-0">
              <a href="#" class="text-[#333333] hover:text-gray-900 dark:hover:text-white">
                  <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                        <path fill-rule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clip-rule="evenodd"/>
                    </svg>
                  <span class="sr-only">Facebook page</span>
              </a>
              <a href="#" class="text-[#333333] hover:text-gray-900 dark:hover:text-white ms-5">
              ...
              <a href="https://github.com/mcDJIL/COMPFEST-17" class="text-[#333333] hover:text-gray-900 dark:hover:text-white ms-5">
